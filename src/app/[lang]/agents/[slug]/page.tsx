        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-bone/75 text-xs mt-1.5 font-bold">
                {agent.title}
              </p>
            </div>
          </div>
            ...
            <ul className="space-y-4 mb-6">
              {productLines.map((line, idx) => (
                <li key={idx} className="flex gap-3 items-start p-4 bg-bone border border-rule-light">
                  <div className="w-1.5 h-1.5 bg-emerald-600 shrink-0 mt-2" />
                  <span className="text-ink text-xs font-semibold leading-relaxed">
                    {line}
                  </span>
                </li>
              ))}
            ...
            <div className="bg-pine text-bone p-6 md:p-8 relative overflow-hidden border border-bone/15 animate-pulse-subtle">
              ...
              <div className="space-y-3 relative z-10">
                <Link
                  ...
                  className="block text-center py-3 bg-emerald-600 hover:bg-emerald-700 text-bone font-bold text-xs transition-colors "
                >

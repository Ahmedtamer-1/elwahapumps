            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {features.map((feat, idx) => (
                <div key={idx} className="flex gap-3 items-start p-4 bg-bone border border-rule-light">
                  ...
                  <span className="text-stone text-xs font-medium leading-normal">{feat}</span>
                </div>
              ))}
            </div>
                  ...
                  return (
                    <li key={relSlug}>
                      <Link
                        ...
                        className="group block p-3 bg-bone hover:bg-emerald-50/50 border border-rule-light hover:border-emerald-200 transition-all duration-200"
                      >

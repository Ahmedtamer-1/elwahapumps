        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-px bg-rule border border-rule">
            <div className="bg-white p-8 sm:p-10">
              {/* Brass for the founding year, pine for today — the only two
                  points on the line, so they are told apart by colour rather
                  than by a rule between them. */}
              <div dir="ltr" className="text-h1 font-extrabold text-brass leading-none">
            ...
            <div className="bg-white p-8 sm:p-10">
              <h3 className="text-h1 font-extrabold text-pine leading-none">

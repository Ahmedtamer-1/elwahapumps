...
export default function ProductCard({
  ...
  return (
    <Link
      ...
      className="flex flex-col justify-between h-full overflow-hidden bg-white border border-rule hover:border-rule transition-all duration-300 group"
    >
      {/* Product Image */}
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-lg font-bold text-ink mb-2 group-hover:text-emerald-600 transition-colors duration-200 line-clamp-2">
          {productTitle}
        </h3>
        ...
        <div className="flex items-center gap-3 mt-auto">
          ...
          <span className="shrink-0 text-center py-2.5 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs transition-colors duration-200">

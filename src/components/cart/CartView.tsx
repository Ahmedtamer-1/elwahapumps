      ...
      <div className="lg:col-span-1">
        <div className="bg-white rounded-2xl border border-neutral-200 p-6 sticky top-28">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-pine hover:bg-emerald-700 disabled:bg-stone-light text-bone font-bold py-3.5 rounded-xl transition-colors"
          >

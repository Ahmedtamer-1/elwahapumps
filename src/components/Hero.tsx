...
/*
 * No `isAr` margin or alignment patches in the copy block below: `dir="rtl"`
 * already places a narrower block, a fixed-width rule and a flex row against
 * the inline-start edge. The patches fought it — `justify-end` put the Arabic
 * buttons on the opposite side from the headline they belong to (S5-T02).
 * The gradient direction keeps its ternary: it has no logical equivalent.
 */
